...
from Process.process import loadMixDataGcl_ER
...
def train_GCN(x_test, x_train, args, experiment_id, iter, fold):
    ...
    traindata_list, testdata_list = loadMixDataGcl_ER(x_train, x_test, args.min_droprate, args.max_droprate, args.drop_prob, 0., 120., args.remove_rate)
...
if __name__ == '__main__':    
    ...
    parser.add_argument('--log_dir', default='../logs/EdgeRemove/Ours/')
    parser.add_argument('--ckpt_dir', default='../ckpt/EdgeRemove/Ours/')
    ...
    parser.add_argument('--remove_rate', default=0., type=float)    
