...
from Process.process import loadMixDataGcl_LN
...
def train_GCN(x_test, x_train, args, experiment_id, iter, fold):
    ...
    traindata_list, testdata_list = loadMixDataGcl_LN(x_train, x_test, args.min_droprate, args.max_droprate, args.drop_prob, 0., 120., args.noise_rate)
...
if __name__ == '__main__':    
    ...
    parser.add_argument('--log_dir', default='../logs/Label/Ours/')
    parser.add_argument('--ckpt_dir', default='../ckpt/Label/Ours/')
    parser.add_argument('--noise_rate', default=0.05, type=float)
