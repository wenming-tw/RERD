...
from Process.process import loadMixDataGcl_NR
...
def train_GCN(x_test, x_train, args, experiment_id, iter, fold):
    ...
    traindata_list, testdata_list = loadMixDataGcl_NR(x_train, x_test, args.min_droprate, args.max_droprate, args.drop_prob, 0., 120., args.remove_rate)
...
if __name__ == '__main__':    
    ...
    parser.add_argument('--log_dir', default='../logs/NodeRemove/Ours/')
    parser.add_argument('--ckpt_dir', default='../ckpt/NodeRemove/Ours/')
