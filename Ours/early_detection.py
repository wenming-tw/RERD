...
from Process.dataset import MixGraphDatasetTime
...
def evaluate(x, time_limit):
    dataset = MixGraphDatasetTime(x, 0, 0, 0, time_limit=time_limit)
...
if __name__ == '__main__':    
    ...
    for iter in range(10):
        ...
        result_0 = evaluate(fold0_x_test, args.time_limit)
        ...
        result_1 = evaluate(fold1_x_test, args.time_limit)
        ...
        result_2 = evaluate(fold2_x_test, args.time_limit)
        ...
        result_3 = evaluate(fold3_x_test, args.time_limit)
        ...
        result_4 = evaluate(fold4_x_test, args.time_limit)
    ...
    if os.path.isfile('../logs/early_detection.csv'):
        df.to_csv('../logs/early_detection.csv', index=False, mode='a', header=False, encoding='utf-8')
    else:
        df.to_csv('../logs/early_detection.csv', index=False, mode='w', header=True, encoding='utf-8')
